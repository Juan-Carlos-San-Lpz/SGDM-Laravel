...
class fechaPagoController extends Controller
{
    ...
    {
        $fechaPago = FechaPago::all(); //load es la clase que se crea en el modelo
    ...
    public function store(Request $request)
    {
        ...
        if (!empty($params_array)) {
            ...
            if ($validate->fails()) {
                ...
                $fechaPago->fecha = $params_array['fecha'];
    ...
    public function update(Request $request)
    {
        ...
        if (!empty($params) && !empty($params_array)) {
            ...
            if ($validate->fails()) {
                ...
                $fechaPago->fecha = $params_array['fecha'];
                // Actualizar usuario
                $id = $params_array['id_fecha_pago'];
                // var_dump($params_array['id_grupo_musica']);
                // die();

                $grupo_update = FechaPago::where('id_fecha_pago', $id)->update($params_array);
    ...
    public function destroy($id, Request $request)
    {
        ...
        // Conseguir el grupo
        $fechaPago = FechaPago::where('id_fecha_pago', $id);
