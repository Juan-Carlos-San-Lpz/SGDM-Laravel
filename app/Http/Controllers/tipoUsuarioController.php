...
class tipoUsuarioController extends Controller
{
    ...
    {
        $tipoUsuario = TipoUsuario::all(); //load es la clase que se crea en el modelo
    ...
    public function store(Request $request)
    {
        ...
        if (!empty($params_array)) {
            ...
            if ($validate->fails()) {
                ...
                $tipoUsuario->nombre_tipo_usuario = $params_array['nombre_tipo_usuario'];
    ...
    public function update(Request $request)
    {
        ...
        if (!empty($params) && !empty($params_array)) {
            ...
            if ($validate->fails()) {
                ...
                $tipoUsuario->nombre_tipo_usuario = $params_array['nombre_tipo_usuario'];
                // Actualizar usuario
                $id = $params_array['id_tipo_usuario'];
                // var_dump($params_array['id_grupo_musica']);
                // die();

                $grupo_update = TipoUsuario::where('id_tipo_usuario', $id)->update($params_array);
    ...
    public function destroy($id, Request $request)
    {
        ...
        // Conseguir el grupo
        $promosionGrupo = TipoUsuario::where('id_tipo_usuario', $id);
